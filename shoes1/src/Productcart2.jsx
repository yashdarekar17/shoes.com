    ...
    return(
       ...
       <div className=" w-80 border-2 rounded-xl m-5 pb-1">
           ...
           < span><button  onClick={(e) => {
                    ...
                    PaymentHandler(e);
                      }} className="  bg-black hover:bg-slate-800 text-white font-sm py-2 px-4 rounded mt-2 mx-2.5 flex justify-center items-center mr-6 ">BUY NOW</button></span>
